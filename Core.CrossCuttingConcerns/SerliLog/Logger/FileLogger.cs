using Core.CrossCuttingConcerns.SerliLog.ConfigurationModels;
using Core.CrossCuttingConcerns.SerliLog.Messages;
...
namespace Core.CrossCuttingConcerns.SerliLog.Logger;
...
public class FileLogger:LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        Logger = new LoggerConfiguration().WriteTo.File(
            logFilePath, rollingInterval: RollingInterval.Day,//hergun yeni bir dosya oluştur
